...
class MultiTranslator(object):
    def __init__(self, translator: Literal["translators", "googletrans"] = "googletrans"):
        self.logger = logging.getLogger(__name__)
        self.logger.setLevel(logging.INFO)
        self.translator_type = translator
        self.google_translator = GoogleTranslate() if translator == "googletrans" else None
    ...
    def translate_text(self, text: str, to_lang: str="en", from_lang: str = "auto") -> Optional[str]:
        ...
        try:
            if self.translator_type == "googletrans":
                ...
                result = ts.translate_text(text, to_language=to_lang, from_language=from_lang)
